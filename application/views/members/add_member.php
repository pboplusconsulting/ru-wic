			...
			<div class="row">
                    <div class="col-sm-4 col-md-3">
                    		<div class="form-group">
                                ...
                                <input value="<?php echo set_value('membership_id'); ?>" required pattern="[a-zA-Z0-9]+[a-zA-Z0-9\s]+" title="Name Field does not allow special characters" name="membership_id" class="form-control" type="text" placeholder="ID"/>
                    ...
                    <div class="col-sm-4 col-md-3">
                    		<div class="form-group">
                                ...
                                <input value="<?php echo set_value('member_name'); ?>" required pattern="[a-zA-Z0-9]+[a-zA-Z0-9\s]+" title="Name Field does not allow special characters" name="member_name" class="form-control" type="text" placeholder="Name"/>
            		...
            		<div class="col-sm-4 col-md-3">
                    		<div class="form-group">
                            	<label>Phone</label>
                                <input name="phone_number" type="text" class="form-control" placeholder="phone no" required pattern="[0-9]{10}" title="Ten Digit Mobile Number"  value="<?php echo set_value('phone_number'); ?>">
                            </div>
                    </div>
                    <div class="col-sm-4 col-md-3">
                    		<div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-3">
                    		<div class="form-group">
                                ...
                                <input type="date" name="date_of_birth" class="form-control" required title="">
                    ...
                    <div class="col-sm-4 col-md-3" >
                    		<div class="form-group" id="anniversary_date_field">
                                ...
                                <input type="date" name="anniversary_date" id="anniversary_date" class="form-control" required title="Please enter anniversary date">
                ...
                <!--    <div class="col-sm-4 col-md-3">
                    ...
                    <div class="col-sm-4 col-md-3">
                    	<div class="form-group">
                             <button type="submit" name="add_member" value="add_member" class="btn btn-ru">Save</button>
                        </div>
                    </div>
            </div>
			</form>
