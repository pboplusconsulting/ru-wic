                ...
                <!--    <div class="col-sm-4 col-md-3">
                    ...
                    <div class="col-sm-4 col-md-3">
                    		<div class="form-group">
								...
								<?php if($data->image){ echo $data->image; ?> <span class="del_pic"><i class="fa fa-close"></i></span> <?php } ?>
                            </div>
                    </div>
                    <div class="col-sm-4 col-md-3">
                    	<div class="form-group">
                             <button type="submit" name="edit_user" value="edit_user" class="btn btn-ru">Save</button>
                        </div>
                    </div>
            </div>
			</form>
